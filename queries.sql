...
UNION ALL SELECT 'messages' as table_name, COUNT(*) as count FROM messages
UNION ALL SELECT 'products' as table_name, COUNT(*) as count FROM products
UNION ALL SELECT 'news' as table_name, COUNT(*) as count FROM news;
